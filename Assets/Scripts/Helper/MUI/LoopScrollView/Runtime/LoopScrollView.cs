...
namespace ET.Client
{
    public class LoopScrollView : ScrollRect
    {
        ...
        public void InitLoopScroll(bool isVisible, int Count)
        {
            var _itemPrefab = ResourceHelper.LoadGameObjectSync<GameObject>(this.prefabName);
        ...
        private void ResetDataAndPos(int startIndex)
        {
            ...
            for (int i = 0; i < itemSlots.Count; i++)
            {
                ...
                OnLoopRefershHandler?.Invoke(itemSlots[i].transform, startIndex + i, moveState);
            }
        }
