		...
		public TMPro.TextMeshProUGUI M_ConentTextMeshProUGUI
     	{
     		get
     		{
     			...
     			{
		    		this.m_M_ConentTextMeshProUGUI = MUIHelepr.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"Center/GameObject/M_Conent");
     			}
		...
		public UnityEngine.UI.Button M_CloseButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_M_CloseButton = MUIHelepr.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Center/GameObject/M_Close");
     			}
		...
		public UnityEngine.UI.Image M_CloseImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_M_CloseImage = MUIHelepr.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Center/GameObject/M_Close");
     			}
