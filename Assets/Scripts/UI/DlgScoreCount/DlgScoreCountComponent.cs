...
using UnityEngine.UI;
	public  class DlgScoreCountComponent : MonoBehaviour
	{
		...
		public TMPro.TextMeshProUGUI M_AllScoreTextMeshProUGUI
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_M_AllScoreTextMeshProUGUI == null )
     			{
		    		this.m_M_AllScoreTextMeshProUGUI = MUIHelepr.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"MG_Center/GameObject (1)/M_AllScore");
     			}
     			return this.m_M_AllScoreTextMeshProUGUI;
     		}
     	}
		...
		public void DestroyWidget()
		{
			...
			this.m_M_AllScoreTextMeshProUGUI = null;
		...
		private TMPro.TextMeshProUGUI m_M_AllScoreTextMeshProUGUI = null;
